...
#
# punlearn specextract
# pset specextract infile ="${evt}[sky=@bkg.reg]"
# pset specextract outroot=fatia/bkg
# # pset specextract grouptype="NUM_CTS"
# # pset specextract binspec=50
# pset specextract bkgresp=no
# specextract mode=h clobber+
...
#   modelflux arf="${arf[${ii}]}" rmf="${rmf[${ii}]}" model="xsphabs.abs1*xsapec.p1" paramvals="abs1.nh=0.07;p1.kT=${kT};p1.Abundanc=${Z};p1.norm=1" emin=0.7 emax=2
